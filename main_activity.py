...
class MainActivity:
    ...
    def init_gui(self):
        ...
        self.mode_btn = Button(left_frame, text="Mode", font=("Arial", 12), width=4, command=self.toggle_mode)
        self.mode_btn.pack(pady=10)
        self.lang_btn = Button(left_frame, text="Lang", font=("Arial", 12), width=4, command=self.toggle_language)
        self.lang_btn.pack(pady=10)
        self.hl_btn = Button(left_frame, text="HL", font=("Arial", 12), width=4, command=self.toggle_highlight)
    ...
    def on_key_press(self, event):
        ...
        # Only compare up to the length of the required text
